...
OUT_TRAIN = "/home/claude/dpo_review/fixture_pairs_train.jsonl"
OUT_EVAL = "/home/claude/dpo_review/fixture_pairs_eval.jsonl"
OUT_AUDIT = "/home/claude/dpo_review/fixture_audit_sample_50.jsonl"
...
for i, p in enumerate(PAIRS, 1):
    records.append({
        ...
        "meta": {"pair_id": f"fc-{i:04d}", "error_type": p["error_type"],
                 ...
                 "synthetic": True,
                 "provenance": "template-generated fixture (scale_pairs.py, seed 20260804); NOT on-policy model generations; for pipeline/verifier testing only, not for training or publication as evidence"},
    })
...
for path, rows in [(OUT_TRAIN, train), (OUT_EVAL, evals), (OUT_AUDIT, audit)]:
